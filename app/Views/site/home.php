<header class="pb-6 bg-slate-600">
  ...
  <div class="mx-auto max-w-screen-xl flex items-center w-full justify-between">
    <a href="" class="font-bold text-3xl text-white">Travel</a>
...
<div class="hero py-40 bg-slate-200 relative before:block before:absolute before:bg-black before:h-full before:w-full before:top-0 before:z-10 before:opacity-70">
  <img src="https://picsum.photos/1920/850" alt="" class="absolute top-0 left-0 h-full w-full object-cover">
...
<div class="bg-white">
  <div class="main max-w-screen-xl mx-auto py-24 bg-white">
    <div class="popular">
      ...
      <div class="list grid grid-cols-4 gap-4">
        ...
        <div class="shadow-md hover:shadow-lg transition-all relative">
          ...
          <div class="bg-white min-h-80 p-2">
            <div class="overflow-hidden h-80">
              <div class="block h-full relative before:block before:absolute before:bg-black before:h-full before:w-full before:top-0 before:z-20 before:opacity-45">
                <img src="https://picsum.photos/450/450" alt="" class="absolute top-0 h-full w-full object-cover">
              </div>
            </div>
          </div>
          <div class="flex items-center flex-col justify-center pb-5 pt-2 relative">
            ...
            <h3 class="text-2xl font-bold text-slate-600 mb-1">Marina Ridge</h3>
            <span class="text-sky-700">NEW ZEALAND</span>
          </div>
        </div>
...
<div class="bg-stone-50">
  ...
  <div class="popular">
    <header class="flex flex-col items-center mb-24">
      <span class="block text-orange-500 font-medium mb-2">POPULAR DESTINATION</span>
      <h2 class="font-extrabold text-5xl">POPULAR PACKAGES</h2>
    </header>
      ...
      <div class="group shadow-md hover:shadow-lg bg-white grid grid-cols-2">
        <div class="relative h-80">
          <div class="absolute bg-rose-500 py-2 pr-3 pl-6 mt-6 text-white">
            <span class="font-bold text-xl">$1.230</span> <span class="text-xs text-stone-200">/ persone</span>
          </div>
          <img src="https://fastly.picsum.photos/id/15/2500/1667.jpg?hmac=Lv03D1Y3AsZ9L2tMMC1KQZekBVaQSDc1waqJ54IHvo4" alt="" class="h-full object-cover">
...
<div class="min-h-96 relative before:block before:absolute before:bg-black before:h-full before:w-full before:top-0 before:z-10 before:opacity-80">
  <img src="https://fastly.picsum.photos/id/15/2500/1667.jpg?hmac=Lv03D1Y3AsZ9L2tMMC1KQZekBVaQSDc1waqJ54IHvo4" alt="" class="h-full object-cover absolute top-0 left-0 w-full ">
  <div class="mx-auto max-w-screen-xl relative z-20 text-white py-20">
    <header class="flex flex-col items-center mb-10">
      <span class="block text-rose-600 font-medium mb-4">CHOOSE OUR ACTIVITIES</span>
      <h2 class="font-extrabold text-5xl">POPULAR PACKAGES</h2>
    ...
    <div class="flex items-center justify-center gap-20">
      <div class="group flex flex-col items-center text-sm relative">
        ...
        <b class="font-bold text-xl block mb-2">Adventure</b>
        15 Destination
      </div>
